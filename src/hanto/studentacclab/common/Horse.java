...
/**
 * This is the horse piece class for the Alpha and Beta Hanto Game
 * @author acclab
 *
 */
public class Horse extends BaseHantoPiece implements HantoPiece {
	 ...
	 */
	public Horse(HantoPlayerColor color, HantoPieceType type) {
		super(color, type);
	}
