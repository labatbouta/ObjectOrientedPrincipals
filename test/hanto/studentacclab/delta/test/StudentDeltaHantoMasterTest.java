...
package hanto.studentacclab.delta.test;
 ...
 * @version Sep 24, 2014
 */
public class StudentDeltaHantoMasterTest
{
	/**
	...
	@Test
	public void flyMultipleSpaces() throws HantoException
	{
		...
		final MoveResult mr = game.makeMove(SPARROW, makeCoordinate(1,-1), makeCoordinate(1, 1));	// Blue
		assertEquals(OK, mr);
	}
	
	@Test(expected=HantoException.class)
	public void tryCrabFly() throws HantoException
	{
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));	// Blue
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 1)); // Red
		game.makeMove(CRAB, null, makeCoordinate(1, -1)); // Blue
		game.makeMove(SPARROW, null, makeCoordinate(0, 2)); // Red
		game.makeMove(CRAB, makeCoordinate(1,-1), makeCoordinate(1, 1));	// Blue
	}
	
	@Test(expected=HantoException.class)
	public void tryButterflyFly() throws HantoException
	{
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));	// Blue
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 1)); // Red
		game.makeMove(BUTTERFLY, makeCoordinate(1,-1), makeCoordinate(1, 0));	// Blue
	}
	
	@Test(expected=HantoException.class)
	public void tryWrongPieceFly() throws HantoException
	{
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));	// Blue
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 1)); // Red
		game.makeMove(SPARROW, makeCoordinate(1,-1), makeCoordinate(1, 0));	// Blue
	}
	
	@Test(expected=HantoException.class)
	public void attemptToFlyMakingBoardNotContiguous() throws HantoException
	{
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));	// Blue
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 1)); // Red
		game.makeMove(SPARROW, null, makeCoordinate(1, -1)); // Blue
		...
		final MoveResult mr = game.makeMove(SPARROW, makeCoordinate(1,-1), makeCoordinate(2, 0));	// Blue
	}
	...
	public void redResigns() throws HantoException {
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));	// Blue
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 1)); // Red
		MoveResult mr = game.makeMove(null, null, null);	// // Blue
		assertEquals(RED_WINS, mr);
	}
	
	@Test
	public void firstPlayerResigns() throws HantoException {
		MoveResult mr = game.makeMove(null, null, null);	// Blue
		assertEquals(RED_WINS, mr);
	...
	public void blueResigns() throws HantoException {
		...
		game.makeMove(SPARROW, null, makeCoordinate(0, 2)); // Red
		game.makeMove(SPARROW, null, makeCoordinate(-1, 0)); // Blue
		MoveResult mr = game.makeMove(null, null, null);	// // Red
		assertEquals(BLUE_WINS, mr);
	}
	
	
	@Test(expected=HantoException.class)
	public void redTriesToMoveAfterBlueWin() throws HantoException
	{
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0));
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, -1));
