 ...
 *******************************************************************************/
package hanto.studentacclab.gamma.test;
 ...
 * @version Sep 14, 2014
 */
public class StudentGammaHantoMasterTest
{
	/**
	...
	public void attemptToMoveAPiece() throws HantoException
	{
		...
		final MoveResult mr = game.makeMove(SPARROW, makeCoordinate(0,0), makeCoordinate(0, -1));	// Blue
	}
	
	@Test(expected=HantoException.class)
	public void attemptToWalkMultipleSpaces() throws HantoException
	{
		game.makeMove(SPARROW, null, makeCoordinate(0, 0));	// Blue
		game.makeMove(SPARROW, null, makeCoordinate(0, 1)); // Red
		game.makeMove(SPARROW, null, makeCoordinate(1, -1)); // Blue
	...
	@Test(expected=HantoException.class)
	public void testIsWalkValidFalse() throws HantoException {
		...
		game.makeMove(SPARROW, null, makeCoordinate(-1, 0)); // 2
		MoveResult m = game.makeMove(SPARROW, makeCoordinate(0, 0), makeCoordinate(1, 0)); 
		
	}
	@Test(expected=HantoException.class)
	public void testIsWalkValidFalse2() throws HantoException {
		game.makeMove(BUTTERFLY, null, makeCoordinate(0, 0)); // 1
		game.makeMove(BUTTERFLY, null, makeCoordinate(-1, 1));
		game.makeMove(SPARROW, null, makeCoordinate(0, -1)); // 2
		game.makeMove(SPARROW, null, makeCoordinate(1, 0)); // 2
		MoveResult m = game.makeMove(SPARROW, makeCoordinate(0, 0), makeCoordinate(0, 1)); 
